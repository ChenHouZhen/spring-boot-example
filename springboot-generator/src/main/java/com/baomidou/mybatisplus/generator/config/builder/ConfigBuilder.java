...
public class ConfigBuilder {
    ...
    public com.baomidou.mybatisplus.generator.config.builder.ConfigBuilder setTableInfoList(List<TableInfo> tableInfoList) {
...
//        }
    ...
    private List<TableInfo> processTable(List<TableInfo> tableList, NamingStrategy strategy, StrategyConfig config) {
        ...
        for (TableInfo tableInfo : tableList) {
            String tbName = NamingStrategy.capitalFirst(processName(tableInfo.getName(), strategy, tablePrefix));
            ...
            if (StringUtils.isNotEmpty(globalConfig.getMapperName())) {
                ...
                tableInfo.setMapperName(tbName + ConstVal.MAPPER);
            }
           /* if (StringUtils.isNotEmpty(globalConfig.getXmlName())) {
                tableInfo.setXmlName(String.format(globalConfig.getXmlName(), tbName));
            } else {
                tableInfo.setXmlName(tbName + ConstVal.MAPPER);
            }*/
            if (StringUtils.isNotEmpty(globalConfig.getServiceName())) {
                tableInfo.setServiceName(String.format(globalConfig.getServiceName(), tbName));
            } else {
                tableInfo.setServiceName(tbName + ConstVal.SERIVCE);
            }
            if (StringUtils.isNotEmpty(globalConfig.getServiceImplName())) {
                tableInfo.setServiceImplName(String.format(globalConfig.getServiceImplName(), tbName));
            } else {
                tableInfo.setServiceImplName(tbName + ConstVal.SERVICEIMPL);
            }
           /* if (StringUtils.isNotEmpty(globalConfig.getControllerName())) {
                tableInfo.setControllerName(String.format(globalConfig.getControllerName(),  tbName));
            } else {
                tableInfo.setControllerName(tbName + ConstVal.CONTROLLER);
            }*/
            //强制开启字段注解
    ...
    public com.baomidou.mybatisplus.generator.config.builder.ConfigBuilder setStrategyConfig(StrategyConfig strategyConfig) {
        this.strategyConfig = strategyConfig;
        return this;
    }
    ...
    public com.baomidou.mybatisplus.generator.config.builder.ConfigBuilder setGlobalConfig(GlobalConfig globalConfig) {
        this.globalConfig = globalConfig;
        return this;
    }
    ...
    public com.baomidou.mybatisplus.generator.config.builder.ConfigBuilder setInjectionConfig(InjectionConfig injectionConfig) {
